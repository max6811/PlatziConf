...
class UbicationDetailDialogFragment : DialogFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setStyle(STYLE_NORMAL, R.style.FullScreenDialogStyle)//importamos el estilo -->codigo reusado
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        toolbarUbucation.navigationIcon = ContextCompat.getDrawable(view.context, R.drawable.ic_close)
        toolbarUbucation.setTitleTextColor(Color.WHITE)
        toolbarUbucation.setNavigationOnClickListener{
            dismiss()
        }

        val ubication = Ubication()
        toolbarUbucation.title = ubication.name

        tvDetailNombreLugar.text = ubication.name
        tvUbucationDireccion.text = ubication.address
        ...
        llTelefonoLugar.setOnClickListener{
            val intent = Intent(Intent.ACTION_DIAL).apply {
                data = Uri.parse("tel:${ubication.phone}")//concatenar variables
            }
